  ...
  return (
    <main className="flex items-center justify-center min-h-screen">
      <div className="w-[98%] max-w-[1440px]">
        <div className="px-5 py-10 bg-white border rounded-lg border-stroke shadow-default dark:border-strokedark dark:bg-boxdark sm:py-20">
          <div className="mx-auto max-w-[410px]">
            <div className="relative overflow-hidden w-full h-[270px]">
              <Image src={notfoundSVG} alt="" fill className="object-cover" />
            </div>
            <div className="mt-7.5 text-center">
              ...
              <Link className="mt-7.5 inline-flex items-center gap-2 rounded-md bg-primary py-3 px-6 font-medium text-white hover:bg-opacity-90 bg-custom-gradient" href="/">
