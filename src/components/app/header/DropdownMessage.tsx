    ...
    <li className="relative">
      ...
      >
        ...
        <ul className="flex flex-col h-auto overflow-y-auto">
          <li>
            <div className="gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4">
              <div>
                <h6 className="text-sm text-black font-large dark:text-white">No new messages</h6>
              </div>
            </div>
          </li>
        </ul>
